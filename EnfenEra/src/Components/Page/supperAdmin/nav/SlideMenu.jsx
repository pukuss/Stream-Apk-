...
function SlideMenu() {
    ...
    const acccenter = [
        { name: "Request", path: "/dashboard/requests-get", icon: NotebookPenIcon },
    ...
    return (
        <>
            <div
                ...
                className={`${openMenu ? "" : "hidden"} w-full h-screen   relative  flex flex-col gap-1 min-w-66.25 z-0 `}>
                <div className=" absolute shadow-[0px_0px_300px_60px] -z-20  border h-20 w-20 -left-20 animate-bounce border-pink-500/40  bg-pink-600/10 rounded-full  shadow-pink-600 " ></div>
                {/* <div className=" absolute shadow-[0px_0px_80px_20px] -z-20 w-full  shadow-red-600 animate-pulse  " ></div> */}
                ...
                <div className=" w-full flex items-center justify-between">
                    ...
                    <div className="flex  items-center gap-2 mx-2 my-2 font-semibold text-gray-500 bg-gray-500/20 hover:text-white cursor-pointer text-sm p-1.5 rounded-xl">
                        {/* <PhoneCall size={15} /> */}
                        <h1
                ...
                <div className="text-xs px-5 border=b w-full font-heading font-bold text-gray-400">Admin Dashboard</div>

                <div className="border-t border-purple-950/50">
                    <section className="  font-semibold text-sm">
                        <NavLink
                            to="#"
                            className={({ isActive }) => `flex py-1.5 px-5 hover:bg-gray-500/20  cursor-pointer gap-3 items-center   ${isActive ? " bg-white/10" : " text-gray-400"}`}>
                            <span>
                ...
                <div>
                    {accountCenter && (
                        <motion.div className="bg-slate-950/10 rounded-sm">
                            <div className="px-3">
                                {acccenter.map((element, index) => {
                                    return (
                                        <NavLink
                                            ...
                                            to={element.path}
                                            className={({ isActive }) =>
                                                `${isActive ? "text-white bg-white/10" : "text-gray-500"} hover:text-white active:scale-95 font-heading flex gap-3 items-center px-3 w-full transition duration-300 rounded-sm hover:bg-white/10 mx-2 py-1.5 font-semibold text-sm `
                                            }>
                            ...
                            <div className=" absolute bottom-5  py-2 rounded-xl nav-bg border border-slate-800  w-full left-60  z-100 ">
                                <div className="border-b-2 border-slate-800">
                                    <div className="p-2 flex gap-5 text-[12px] font-bold px-3 items-center h-full">
                                        ...
                                        <div className="flex flex-col">
                                            <h1 className="flex gap-1 text-sm bg-clip-text text-transparent w-fit bg-linear-to-r from-pink-700  via-orange-500 to-yellow-400  w-fit font-bold items-center">
                                                {user?.name } 
