...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-black text-white py-20 px-6">
      ...
      >
        ...
        <div className="flex flex-col gap-24 relative">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start relative">
            ...
            >
              <p className="text-blue-500 font-light text-xs uppercase tracking-[0.5em] mb-6">
                End Transmission
              </p>
            ...
            <div className="mt-10 md:mt-0 flex flex-col items-end gap-2 text-right">
              ...
              <div className="flex items-center gap-2 group cursor-pointer">
                <Globe
                  size={14}
                  className="text-blue-500 group-hover:rotate-180 transition-transform duration-1000"
                />
          ...
          {/* Navigation Section */}
          <div className="relative grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-white/5 pt-12">
            
            {/* Social Links */}
            <div className="col-span-1 flex flex-col gap-2">
              
              <p className="text-[10px] text-zinc-600 uppercase font-black tracking-widest mb-4">
                Pulse
              </p>
            ...
            <div className="col-span-1 flex flex-col gap-2">
              ...
              <p className="text-[10px] text-zinc-600 uppercase font-bold tracking-widest mb-4">
                Code
              </p>
