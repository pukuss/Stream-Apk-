  ...
  return (
    <>
      <div className="w-full h-full ">
        <form action="">
          {/* //Custoom Rules  */}
          <div className="font-bold min-h-30 p-2">
            <label className="flex p-2 gap-2" htmlFor="customRules">
              <Info color="gray" />  Costoom Rules*
            </label>
            <input
              className=" border w-full h-full font-stretch-95% font-medium rounded-2xl border-gray-400 text-gray-50  p-3 px-4  pb-25"
